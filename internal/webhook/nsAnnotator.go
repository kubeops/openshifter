...
// +kubebuilder:webhook:path=/mutate--v1-namespace,mutating=true,failurePolicy=fail,groups="",resources=namespaces,verbs=create;update,versions=v1,name=mpod.kb.io
